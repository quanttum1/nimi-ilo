...
D_EXTEND("li.pona.la",
    ...
    // ike la ilo tawa ni^ li pali pona ala
...
D_EXTEND("mi.pona.la",
    ...
    CNAME("mta-sts", "mail.osphost.fi."),
    TXT("_mta-sts", "v=STSv1; id=15464186564434072107"),
    CNAME("ua-auto-config", "mail.osphost.fi."),
    TXT("_ua-auto-config", "v=UAAC1; a=sha256; d=6zmxye3ArQ3rxNTOjCV8arUBnkBVT5lL6M3gVdmmbfo="),
    CNAME("autoconfig", "mail.osphost.fi."),
    CNAME("autodiscover", "mail.osphost.fi."),
);
